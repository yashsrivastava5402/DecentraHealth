...
class _PatientLoginScreenState extends State<PatientLoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: widget.user == Users.patient
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  labelText:
                      '${widget.user.toString().substring(6)[0].toUpperCase()}${widget.user.toString().substring(7)} ID',
            ...
            RoundTextButton(
                label:
                    '${widget.user.toString().substring(6)[0].toUpperCase()}${widget.user.toString().substring(7)} Login',
                whenPressed: () async {
                  // await dataWrite();
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => PatientLoggedInScreen()));
                }),
            const SizedBox(
              height: 130,
            ),

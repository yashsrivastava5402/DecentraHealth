    ...
    if(flag===0){
            ...
            let testBuffer = new Buffer(testFile);
               ...
               let file = await ipfs.files.add(testBuffer);
                ...
                let link = `https://decentrahealth-server.onrender.com/fileDownload/${Aadhar}/${file[0].hash}`;
    ...
    await Promise.all( files.map( async(currfile, i) => {
        ...
        await currfile.mv(`${newpath}/${fileName[i]}`,async (err) => {
            ...
            let testBuffer = new Buffer(testFile);
                ...
                let link = `https://decentrahealth-server.onrender.com/fileDownload/${Aadhar}/${newfile[0].hash}`; 
...
exports.viewFiles =async (req, res) => {
    ...
    //                 var link = `https://decentrahealth-server.onrender.com/fileDownload/${aadhar}/${file}`;
    ...
    {
        let element=data[i];
        var link = `https://decentrahealth-server.onrender.com/fileDownload/${aadhar}/${element.userDataDetail}`;
        const output = {

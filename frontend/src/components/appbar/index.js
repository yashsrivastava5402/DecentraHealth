  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        <li className="nav-item hover:text-red-900">
          <p className="cursor-pointer text-2xl nav-link active hover:text-red-900" onClick={() => {navigate("/");}}>Home</p>
        </li>
        <li className="nav-item">
          <p className="cursor-pointer text-2xl nav-link active hover:text-red-900" onClick={() => {navigate("/PatientLogin");}}>Patient</p>
        </li>
        <li className="nav-item">
          <p className="cursor-pointer text-2xl nav-link active hover:text-[#1CB7B9]" onClick={() => {navigate("/DoctorLogin");}}>Doctor</p>
        </li>
        <li className="nav-item">
          <p className="cursor-pointer text-2xl nav-link active hover:text-[#1CB7B9]" onClick={() => {navigate("/HospitalLogin");}}>Hospital</p>
        </li>
        <li className="nav-item">
          <p className="cursor-pointer text-2xl nav-link active hover:text-[#1CB7B9]" onClick={() => {navigate("/");}}>Contact</p>
        </li>
      </ul>
    </div>
  </div>
